...
void GenerateTextures()
{
	...
	error = load_targa("c220.tga", width, height, format, type, pixels);
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku c220.tga");
		exit(0);
	}
...
//2 Okna
	...
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-0.45, 0.05, 1.01);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(0.45, 0.05, 1.01);
	glTexCoord2f(1.0, 2.0);
	glVertex3f(0.45, 0.95, 1.01);
	glTexCoord2f(0.0, 2.0);
	glVertex3f(-0.45, 0.95, 1.01);
